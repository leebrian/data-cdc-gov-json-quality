# data-cdc-gov-json-quality
Automated quality checks for the cdc.gov data.json. Personal project, but figured I will use the cdc template in case I ever move it over.
